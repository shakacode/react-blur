...
function stackBlurImage(img, canvas, radius, w, h) {
    ...
    // https://sentry.io/friends-and-guests/front-end/issues/428806856
    // when the image is hidden (itself or because of parent Node) there is an error caused in StackBlur
    if(w == 0 || h == 0) return;
